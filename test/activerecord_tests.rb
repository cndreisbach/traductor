...
context "En español" do
  ...
  context "OficinaDeTurismo" do
    should("have a human name") { OficinaDeTurismo.human_name }.matches "Oficina De Turismo"
    should("use the right table") { OficinaDeTurismo.table_name }.matches "oficinas_de_turismo"
  end
